...
public class EmployeeSchedulingConstraintProviderTest {
    ...
    private static final LocalDateTime DAY_START_TIME = DAY_1.atTime(LocalTime.of(8, 0));
    private static final LocalDateTime DAY_END_TIME = DAY_1.atTime(LocalTime.of(16.5, 0));
    ...
    private static final LocalDateTime NIGHT_START_TIME = DAY_1.atTime(LocalTime.of(16, 0));
    private static final LocalDateTime NIGHT_END_TIME = DAY_1.atTime(LocalTime.of(23.9, 0));
    @Inject
    ConstraintVerifier<EmployeeSchedulingConstraintProvider, EmployeeSchedule> constraintVerifier;

    @Test
    public void testRequiredSkill() {
        Employee employee = new Employee("Asdrubal", Set.of());
        ...
        employee = new Employee("Berta", Set.of("Skill"));
        constraintVerifier.verifyThat(EmployeeSchedulingConstraintProvider::requiredSkill)
                .given(employee,
                       new Shift(DAY_START_TIME, DAY_END_TIME, "Location", "Skill", employee))
                .penalizes(0);
    ...
    public void testOverlappingShifts() {
        Employee employee1 = new Employee("Asdrubal", Set.of("Skill"));
        Employee employee2 = new Employee("Berta", Set.of("Skill"));
